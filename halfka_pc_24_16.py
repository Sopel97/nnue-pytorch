  ...
  for ksq in range(64):
    for s in range(64):
      for pt, val in piece_values.items():
        ...
        values[idxw] = val
        values[idxb] = -val
        values[idxw + NUM_PLANES * NUM_SQ] = val
        values[idxb + NUM_PLANES * NUM_SQ] = -val
        values[idxw + NUM_PLANES * NUM_SQ * 2] = val
        values[idxb + NUM_PLANES * NUM_SQ * 2] = -val

  return values

class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKA_PC_24_16', 0x5f134cb8, OrderedDict([('HalfKA_PC_24_16', NUM_PLANES * NUM_SQ * 3)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKA_PC_24_16^', 0x5f134cb8, OrderedDict([('HalfKA_PC_24_16', NUM_PLANES * NUM_SQ * 3), ('A', NUM_SQ * NUM_PT)]))
