...
NUM_INPUTS = NUM_PLANES_REAL * NUM_SQ // 4
...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKAv2_hm_b16', 0x7f164cb8, OrderedDict([('HalfKAv2_hm_b16', NUM_INPUTS)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKAv2_hm_b16^', 0x7f164cb8, OrderedDict([('HalfKAv2_hm_b16', NUM_INPUTS), ('A', NUM_PLANES_VIRTUAL)]))
