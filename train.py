...
def main():
  ...
  if args.resume_from_model is None:
    nnue = M.NNUE(feature_set=feature_set, lambda_=args.lambda_, layer_sizes=net_size)
  else:
  ...
  checkpoint_callback = pl.callbacks.ModelCheckpoint(save_last=True, period=50, save_top_k=-1)
