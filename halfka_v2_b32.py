...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKAv2_b32', 0xb3234cb8, OrderedDict([('HalfKAv2_b32', NUM_PLANES_REAL * NUM_KING_BUCKETS)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKAv2_b32^', 0xb3234cb8, OrderedDict([('HalfKAv2_b32', NUM_PLANES_REAL * NUM_KING_BUCKETS), ('A', NUM_PLANES_VIRTUAL)]))
