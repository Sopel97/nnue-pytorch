...
class Features(FeatureBlock):
  def __init__(self):
    super(Features, self).__init__('HalfKA_PC20', 0x5f134cb8, OrderedDict([('HalfKA_PC20', NUM_PLANES * NUM_SQ * 2)]))
...
class FactorizedFeatures(FeatureBlock):
  def __init__(self):
    super(FactorizedFeatures, self).__init__('HalfKA_PC20^', 0x5f134cb8, OrderedDict([('HalfKA_PC20', NUM_PLANES * NUM_SQ * 2), ('A', NUM_SQ * NUM_PT)]))
